...
The data used for this assembly will consist of raw *Salmonella enterica* reads generated by an **Oxford Nanopore sequencer** using **R10 chemistry** and provided in **FASTQ format**. The dataset is publicly available through the NCBI Sequence Read Archive under the accession **SRR32410565**. The reference genome will also be downloaded from NCBI in **FASTA format**.
